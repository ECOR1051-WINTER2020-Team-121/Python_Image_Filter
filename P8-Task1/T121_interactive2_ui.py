...
def main()-> Cimpl.Image:
    ...
    while test_variable == 0:
        ...
        if selected_option == "L)":
            ...
            #first input is Cimpl.Image, Second is dark pixel replacement
            #third is light pixel replacement
            image_selected = two_tone(image_selected,"yellow","cyan")
            Cimpl.show(image_selected)
        
        elif selected_option == "3)" and image_selected != 0:
            #first input is Cimpl.Image, Second is dark pixel replacement
            #third is light pixel replacement and fourth is gray color replacement        
            image_selected = three_tone(image_selected,"yellow","cyan","magenta")
            Cimpl.show(image_selected)
