...
def test_imp_edge_better()-> bool:
    """ The author: Ibrahim Kasim
    It returns true or false depending on whether the improved edge detection filter works. The threshold value
    will be 4 for in this function.
    """
    original_image = Cimpl.create_image(6,2)#original image has to have a height of 6 and width of 2 in order to consider 5 cases.
    
    # The first boundary case: 
    # if the difference in the brightness of the top pixel and the bottom pixel is less than the threshold value 
    ...
    # if the difference in the brightness of the top pixel and the bottom pixel is equal to the threshold value 
    ...
    # if the difference in the brightness of the top pixel and the bottom pixel is greater than the threshold value 
    # The top pixel will be set to black pixel. (20,20,20) -> (0,0,0)
    ...
    # if the difference in the brightness of the top pixel and the bottom pixel is less than the threshold value 
    # if the difference in the brightness of the top and the right pixel is equal to the threshold value
    # The top pixel will be set to black pixel. (20,20,20) -> (0,0,0)
    ...
    # if the difference in the brightness of the top pixel and the bottom pixel is less than the threshold value 
    # if the difference in the brightness of the top and the right pixel is greater than the threshold value
    ...
    Cimpl.set_color(original_image,5,1,Cimpl.create_color(255,255,255)) #the right of the last one


    expected = Cimpl.create_image(6,2) 
    Cimpl.set_color(expected,0,0,Cimpl.create_color(255,255,255)) #(23,23,23) -> (255,255,255)
    Cimpl.set_color(expected,1,0,Cimpl.create_color(0,0,0)) #(20,20,20) -> (0,0,0)
    Cimpl.set_color(expected,2,0,Cimpl.create_color(0,0,0)) # (20,20,20) -> (0,0,0)
    Cimpl.set_color(expected,3,0,Cimpl.create_color(0,0,0)) #(20,20,20) -> (0,0,0)
    Cimpl.set_color(expected,4,0,Cimpl.create_color(0,0,0)) #(21,21,21) -> (0,0,0)
    Cimpl.set_color(original_image,5,0,Cimpl.create_color(255,255,255)) # the last row has to be whited 
    
    Cimpl.set_color(expected,0,1,Cimpl.create_color(255,255,255)) #right (23,23,23) -> (255,255,255)
    Cimpl.set_color(expected,1,1,Cimpl.create_color(0,0,0)) #right (20,20,20) -> (0,0,0)
    Cimpl.set_color(expected,2,1,Cimpl.create_color(0,0,0)) #right (16,16,16) -> (0,0,0)
    Cimpl.set_color(expected,3,1,Cimpl.create_color(0,0,0)) #right (0,0,0) -> (0,0,0)
    Cimpl.set_color(expected,4,1,Cimpl.create_color(0,0,0)) #right (26,26,26) -> (0,0,0)
    Cimpl.set_color(original_image,5,1,Cimpl.create_color(255,255,255))# the last row has to be whited 
